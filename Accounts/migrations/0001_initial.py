...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profilePicture', models.ImageField(blank=True, null=True, upload_to='Images/UserProfile/', verbose_name='Profile Picture')),
                ('addressLine_1', models.CharField(max_length=150, verbose_name='Address Line 1')),
                ('addressLine_2', models.CharField(blank=True, max_length=150, verbose_name='Address Line 2')),
